...
// load map
d3.json('https://raw.githubusercontent.com/d33con/d3-meteorite-strike-map/master/data/world-110m.json', function (error, topology) {
  ...
  g.selectAll('path')
    ...
    .geometries)
      ...
      // load strike data
      d3.json('https://raw.githubusercontent.com/coniconon/IDI1015_Fase2/master/terremotos/js/terremotos.json', function (error, data) {
